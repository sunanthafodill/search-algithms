...
# Create a window
window = pyglet.window.Window(width=820, height=200, caption='Binary Search Visualization')
batch = pyglet.graphics.Batch()

# Generate a sorted list with random numbers ensuring 57 is included
numbers = sorted(random.sample(range(1, 100), 19) + [57])
...
def on_draw():
    ...
    for i, number in enumerate(numbers):
        ...
        if left <= i <= right and not search_complete:
            ...
            color = (255, 255, 255)  # White for eliminated elements
