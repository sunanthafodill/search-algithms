...
def reset_searches():
    ...
    # Generate a list with random numbers and include 57, then sort it for binary search
    numbers = random.sample(range(1, 100), 31) + [57]
...
def update_searches(dt):
    ...
    if not binary_found and binary_left <= binary_right:
        binary_mid = (binary_left + binary_right) // 2
        if numbers[binary_mid] == 57:
            binary_found = True
        elif numbers[binary_mid] < 57:
...
def on_draw():
    ...
    for i, number in enumerate(numbers):
        ...
        color_linear = (0, 255, 0) if linear_found and i == linear_index - 1 else (255, 0, 0) if i == linear_index else (255, 255, 255)
        ...
        color_binary = (0, 255, 0) if binary_found and i == binary_mid else (255, 0, 0) if binary_left <= i <= binary_right else (255, 255, 255)
