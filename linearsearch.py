...
# Create a window
window = pyglet.window.Window(width=820, height=200, caption='Linear Search Visualization')
batch = pyglet.graphics.Batch()

# Generate a list with random numbers ensuring 57 is included
numbers = random.sample(range(1, 100), 19) + [57]
...
def on_draw():
    ...
    for i, number in enumerate(numbers):
        ...
        if i == current_index and not search_complete:
            ...
            color = (0, 255, 0)  # Green if 57 is found
        else:
            color = (255, 255, 255)  # White for unchecked or passed boxes
